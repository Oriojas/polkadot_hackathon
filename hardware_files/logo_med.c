...
#ifndef LV_ATTRIBUTE_IMG_LOGO_MED
#define LV_ATTRIBUTE_IMG_LOGO_MED
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_LOGO_MED uint8_t logo_med_map[] = {
